    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="w-full py-16 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="text-2xl font-bold text-[#073379] mb-4 text-center">Our Promises</h2>
            <ul className="space-y-4">
              <li>
                <p className="text-[#073379] font-semibold">Quality First</p>
                <p className="text-gray-700">We deliver durable, high-standard workmanship on every project, big or small.</p>
              </li>
              <li>
                <p className="text-[#073379] font-semibold">On-Time Delivery</p>
                <p className="text-gray-700">We respect your time and strive to meet all project deadlines without compromising quality.</p>
              </li>
              <li>
                <p className="text-[#073379] font-semibold">Transparent Communication</p>
          ...
          {/* Our Values */}
          <div className="flex flex-col">
            <h2 className="text-2xl font-bold text-[#073379] mb-4 text-center">Our Values</h2>
      ...
      <section className="w-full py-12 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <Link href="/contact" className="bg-gray-200 text-[#073379] px-6 py-2 rounded-md font-medium hover:bg-gray-300 transition duration-300 inline-block">
            Get a Quote
          </Link>
